    ...
    <div className="space-y-6 mb-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div>
          ...
          <p className="text-text-body text-sm mt-1">Manage and monitor all your job postings.</p>
        </div>
        <button
      ...
      <form onSubmit={handleSearch} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <p className="text-sm text-text-body">
            Showing <span className="font-bold text-text-dark">{(meta.page - 1) * meta.limit + 1}</span> - <span className="font-bold text-text-dark">{Math.min(meta.page * meta.limit, meta.total)}</span> of <span className="font-bold text-text-dark">{meta.total}</span> jobs
        </p>
      </div>
