  ...
  return (
    <div className='bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden'>
        ...
        <table className='w-full text-left border-collapse min-w-150 md:min-w-0'>
          <thead>
            <tr className='bg-bg-light border-b border-gray-200 text-sm text-text-body'>
              ...
              <th className='py-3 px-6 font-semibold hidden md:table-cell'>
                Location
              </th>
              <th className='py-3 px-6 font-semibold hidden lg:table-cell'>
                Category
              </th>
      ...
      <ConfirmModal
        ...
        confirmLabel={
          modal.title === "Error" || modal.title === "Network Error"
            ? "Close"
            : "Delete"
        }
      />
