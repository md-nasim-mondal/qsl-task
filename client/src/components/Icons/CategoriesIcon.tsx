const getColor = (highlighted: boolean) =>
  highlighted ? "#FFFFFF" : "#4640DE";

export const CategoriesIcon = {
  design: (highlighted: boolean = false) => {
    const color = getColor(highlighted);
    ...
    return (
      <svg
        ...
        <g>
          <path
            d='M6 42H14L40 16C41.0609 14.9393 41.6569 13.5004 41.6569 12C41.6569 10.4998 41.0609 9.06098 40 8C38.9391 6.93925 37.5003 6.34326 36 6.34326C34.4997 6.34326 33.0609 6.93925 32 8L6 34V42Z'
            stroke={color}
            strokeWidth='3'
            strokeLinecap='round'
  ...
  sales: (highlighted: boolean = false) => {
    const color = getColor(highlighted);
  ...
  marketing: (highlighted: boolean = false) => {
    const color = getColor(highlighted);
  ...
  finance: (highlighted: boolean = false) => {
    const color = getColor(highlighted);
  ...
  technology: (highlighted: boolean = false) => {
    const color = getColor(highlighted);
    ...
    return (
      <svg
        ...
        fill='none'>
        <path
          d='M19.5 34L18 40L16 42H32L30 40L28.5 34H19.5Z'
          stroke={color}
          strokeWidth='3'
          strokeLinecap='round'
          strokeLinejoin='round'
        />
        <path d='M6 26H42' stroke={color} strokeWidth='3' />
        <path
          d='M10 34H38C39.0609 34 40.0783 33.5786 40.8284 32.8284C41.5786 32.0783 42 31.0609 42 30V10C42 8.93913 41.5786 7.92172 40.8284 7.17157C40.0783 6.42143 39.0609 6 38 6H10C8.93913 6 7.92172 6.42143 7.17157 7.17157C6.42143 7.92172 6 8.93913 6 10V30C6 31.0609 6.42143 32.0783 7.17157 32.8284C7.92172 33.5786 8.93913 34 10 34Z'
          stroke={color}
          strokeWidth='3'
        />
      </svg>
  ...
  engineering: (highlighted: boolean = false) => {
    const color = getColor(highlighted);
  ...
  humanResources: (highlighted: boolean = false) => {
    const color = highlighted ? "#FFFFFF" : "#4640DE";
